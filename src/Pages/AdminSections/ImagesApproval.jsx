        ...
        const fetchPendingImages = async () => {
            try {
                ...
                const res = await axios.get(
                    "https://localhost:7148/api/admin/pending-images",
                    {
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-5 border-b border-blue-300 pb-3">
                ...
                <div className="flex justify-between sm:justify-end gap-2 w-full sm:w-auto">
                    <button
                        ...
                        className="flex-1 sm:flex-none flex items-center justify-center gap-1 px-2 sm:px-4 py-2 rounded-lg bg-green-100 text-green-700 font-medium hover:bg-green-200 transition text-xs sm:text-base"
                    >
                        Accept All
                    </button>
                    ...
                    <button
                        ...
                        className="flex-1 sm:flex-none flex items-center justify-center gap-1 px-2 sm:px-4 py-2 rounded-lg bg-red-100 text-red-700 font-medium hover:bg-red-200 transition text-xs sm:text-base"
                    >
                        Reject All
                    </button>
